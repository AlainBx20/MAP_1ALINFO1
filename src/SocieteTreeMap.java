...
public class SocieteTreeMap implements InterfaceSociete {
    ...
    public SocieteTreeMap() {
        // TreeMap avec un comparateur pour les Employes (par CIN)
        this.employeDepartementMap = new TreeMap<>(new Comparator<Employe>() {
            @Override
            public int compare(Employe e1, Employe e2) {
                if (e1.getCin() == null && e2.getCin() == null) return 0;
                if (e1.getCin() == null) return -1;
                if (e2.getCin() == null) return 1;
    ...
    public void afficherLesEmployesLeursDepartements() {
        ...
        System.out.println("=== Liste des employés et leurs départements (triés par CIN) ===");
    ...
    public void afficherLesEmployes() {
        ...
        System.out.println("=== Liste des employés (triés par CIN) ===");
